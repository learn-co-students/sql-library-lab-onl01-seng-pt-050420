...
def select_name_and_series_subgenres_of_authors
  ...
  FROM authors
  JOIN series ON series.author_id = authors.id JOIN subgenres ON series.subgenre_id = subgenres.id"
end
...
def select_character_names_and_number_of_books_they_are_in
  ...
  JOIN characters ON character_books.character_id = characters.id GROUP BY characters.name ORDER BY book_count DESC"
